...
- [x] Plymouth 品牌启动界面与图形/纯文字 GRUB 模式选择
- [x] 浏览器、应用商店、文件管理器与终端的系统级菜单收藏
- [x] QEMU/OVMF 桌面就绪与真实帧缓冲 E2E
- [x] 终端、浏览器、应用商店、网络与音频功能 E2E
...
- [x] 品牌化 Calamares 与 Live 桌面安装入口
- [x] GPT、FAT EFI、ext4 根分区和用户创建
- [x] 完全断网安装与安装后 Live/安装器组件清理
- [x] 移除 ISO 后从虚拟硬盘启动、SDDM 登录与 Plasma 验收
