...
- 产品为 LC300A / 落川OS 300型，开发版本 `0.3.2-dev`，基于 Debian 13（trixie）amd64。
...
- `make test`：48 个单元测试、4 个 os-release fixture、bootstrap、清理、产品、品牌、桌面、安装器与仓库卫生契约通过。
...
- `make test-apps`：Konsole、Firefox、Discover 应用卡片、真实 HTTPS 页面与正文绘制通过；自动启动音活跃时长未超过 2.5 秒且未检测到自动 BGM，手工播放后捕获 9.63 秒有效 QEMU 音频，峰值 7,843、非零采样 297,264。
- `make test-installer`：完全断网安装、GPT、ext4、FAT EFI、`hwclock`、GRUB、完成页、安装后清理、移除 ISO 后启动、串口登录、SDDM 和 Plasma 通过。
- 当前 ISO 为 1,820,997,632 字节、1,617 个包，SHA-256 为 `1636f389208055e3068a9a9c61740d61ed0647c3d74b0249bddb91466b9d17d4`。
