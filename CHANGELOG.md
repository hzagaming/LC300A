...
本项目遵循语义化版本。当前处于首次可启动 ISO 之前的开发阶段。

## [Unreleased]

### Added

- 阶段 0 项目结构、产品配置、文档、环境诊断、引导脚本和基础 CI。
- 产品配置契约、负向单元测试、集中式 Linux 依赖清单和严格 CI 工具链验证。
- 仓库卫生与凭据扫描、统一 LF 行尾、编辑器配置和 root/非 root APT 执行路径。
